...
namespace PharmApp
{
    public class DbConnector2
    {
        ...
        //{
        //    using (MySqlConnection conn = new MySqlConnection("server=localhost;user=root;database=pharmacydb;port=3306;password=WhaleOne1;" +
        ...
        {
            using (MySqlConnection conn = new MySqlConnection("server=localhost;user=root;database=pharmacydb;port=3306;password=WhaleOne1;" + "ConvertZeroDateTime=True;AllowZeroDateTime=True;"))
            {
                conn.Open();
                try
                {
